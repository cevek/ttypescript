...
function preparePluginsFromCompilerOptions(plugins: any): PluginConfig[] {
 ...
 function injectionShadowedValues(target : any){
    ...
    //   ];
    //   target.transpileOptionValueCompilerOptions = optionDeclarations.filter((option) => Object.prototype.hasOwnProperty.call(option, "transpileOptionValue"));
    return target;
 }